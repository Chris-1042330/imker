                                ...
                                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                    ...
                                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                                        <x-dropdown align="left" width="48">
                                            ...
                                            <x-slot name="content">
                                                <x-nav-link :href="route('adm/users')" :active="request()->routeIs('Basiscursus')">
                                                    {{ __('Basiscursus') }}
                                                </x-nav-link>
                                                <x-nav-link :href="route('adm/users')" :active="request()->routeIs('Bijscholing')">
                                                    {{ __('Bijscholing') }}
                                                </x-nav-link>
                                                <x-nav-link :href="route('adm/users')" :active="request()->routeIs('Cursusblog')">
                                                    {{ __('Cursusblog') }}
                                                </x-nav-link>
                                            </x-slot>
                                        </x-dropdown>
